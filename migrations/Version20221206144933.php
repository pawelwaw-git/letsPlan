 ...
 */
final class Version20221206144933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE turnament (id INT AUTO_INCREMENT NOT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', rounds INT NOT NULL, current_round INT NOT NULL, finished TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE turnament_goal (turnament_id INT NOT NULL, goal_id INT NOT NULL, INDEX IDX_68939B7E40B77CEA (turnament_id), INDEX IDX_68939B7E667D1AFE (goal_id), PRIMARY KEY(turnament_id, goal_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
